...
/**
 * A Java wrapper for <code>Tesseract OCR DLL</code> using <code>JNA Direct Mapping</code>.
 */
public class TessDllAPI1 implements Library {
    ...
    /**
     * Registers the class library.
     */
    static {
        Native.register(LIB_NAME);
    }
     ...
     * @return
     */
    public static native int TessDllBeginPage(int xsize, int ysize, ByteBuffer buf);
     ...
     * @return
     */
    public static native int TessDllBeginPageLang(int xsize, int ysize, ByteBuffer buf, String lang);
     ...
     * @return
     */
    public static native int TessDllBeginPageUpright(int xsize, int ysize, ByteBuffer buf, String lang);
     ...
     * @return
     */
    public static native int TessDllBeginPageBPP(int xsize, int ysize, ByteBuffer buf, byte bpp);
     ...
     * @return
     */
    public static native int TessDllBeginPageLangBPP(int xsize, int ysize, ByteBuffer buf, String lang, byte bpp);
     ...
     * @return
     */
    public static native int TessDllBeginPageUprightBPP(int xsize, int ysize, ByteBuffer buf, String lang, byte bpp);

    /**
     * Ends page.
     */
    public static native void TessDllEndPage();
     ...
     * @return
     */
    public static native ETEXT_DESC TessDllRecognize_a_Block(int left, int right, int top, int bottom);
     ...
     * @return
     */
    public static native ETEXT_DESC TessDllRecognize_all_Words();

    /**
     * Releases any memory associated with the recognize class object.
     */
    public static native void TessDllRelease();
}
